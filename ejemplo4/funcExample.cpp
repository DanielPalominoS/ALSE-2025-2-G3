...
{
    b = b * b; // This modification will affect the original variable
...
int byReferenceReadOnly(const int &c)
{
    ...
    cout << "Using c to compute square of c: " << c * c << endl;
    cout << "Local c address = " << &c << endl;
    return c * c;
}
